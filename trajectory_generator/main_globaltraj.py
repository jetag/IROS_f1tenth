...
if input_map != "wp":
    file_paths["track_name"] = input_map
...
imp_opts = {"flip_imp_track": False,                # flip imported track to reverse direction
            ...
            "min_track_width": 1.0,                # [m] minimum enforced track width (set None to deactivate)
...
file_paths["track_file"] = os.path.join(file_paths["module"], "inputs", add + file_paths["track_name"] + ext)
...
print(file_paths["traj_race_export"])
